...
public class Smokescreen extends AbstractPreparedCard {

    // TEXT DECLARATION

    public static final String ID = theArcher.TheArcher.makeID(Smokescreen.class.getSimpleName());
    ...
    public Smokescreen() {
        ...
        this.theArcherPreparedBaseSecondMagicNumber = theArcherPreparedSecondMagicNumber = 2;
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(m, p, new WeakPower(m, this.theArcherPreparedSecondMagicNumber, false)));
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            this.upgradeBlock(2);
            this.theArcherPreparedBaseSecondMagicNumber = theArcherPreparedSecondMagicNumber = 3;
