...
public class DrawPileShotToHandAction extends AbstractGameAction {
    private AbstractPlayer p;
    private AbstractCard.CardTags tagsToCheck;

    public DrawPileShotToHandAction(int amount, AbstractCard.CardTags tags) {
